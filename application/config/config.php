...
$config['availabilityCalendar'] =  '{table_open}<table border="0" cellpadding="2" cellspacing="2" width="300px">{/table_open}
		   ...
		   {cal_cell_no_content_today}<span style="font-weight:bold">{day}</span>{/cal_cell_no_content_today}
